...
void play_frazi(int kol_fraz,  int folder , int time_zad , int fraz1  , int fraz2 =0, int fraz3 =0, int fraz4=0 , int fraz5=0 , int fraz6=0 , int fraz7=0 , int fraz8=0 , int fraz9=0, int fraz10=0);
...
#if defined(d_102) ||  defined(d_104)
