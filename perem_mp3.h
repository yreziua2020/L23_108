...
String tekst [] ={"a","  B bi ","  C si  ","  D di  ","  E i и ","  F ef  ","  G dʒi"," H eitʃ","  I ai  "," J dʒei"," K kei  "," L el  "," M em  "," N en  "," O оу  "," P pi  "," Q kju ","  R a  "," S es " ,"  T ti  "," U ju  "," V vi "," W 'dʌblju"," X eks " ," Y wai "," Z zed "};
bool f_angl;
