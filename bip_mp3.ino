...
{     //unsigned long t_tmp = millis() ;  
    ...
    {   // Serial.println("");
        ...
        if (caun_zv2==masiv[0]) {Serial.println("");Serial.print("cmd");Serial.print(caun_zv);Serial.print(" ");caun_zv2=0; pr_bip_full=0; f_kuku=0;   return;}
         caun_zv2++;
        ...
        // if (digitalRead(12))  {f_Fold_ADVE=1; }  else  {f_Fold_ADVE=0;}
         if (f_Fold_ADVE) { Serial.print("старт_F"); command2(Fold,7,masiv[caun_zv2]); } else  {Serial.print("старт_A");command2(ADVE,0,masiv[caun_zv2]); }
