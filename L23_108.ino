...
/*
     switch (f_angl)    
      {
       case 1:{showSimpleDate(); 
       
       
       break;}
       case 2:{showSimpleDate(); 
 ...
 if (!f_govorit_fraz)  //если говорим фразу то не опрашиваем датчики
{
 ...
 if (minute==0 && second==0 && secFr==0 && (hour>=kuOn && hour<kuOff)) { f_kuku=1; play_frazi(5 ,212, dayOfWeek+30, day+40, month+80, hour, 7 );}  //при куку не говорим минуты минуты только с веба
