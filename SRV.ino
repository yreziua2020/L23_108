...
void handle_timepc() {
 ...
 play_frazi(7,7,100, 100,218, 212, day+40, month+80, dayOfWeek+30, hour , minute+100);   //dayOfWeek+30,
...
void handle_weather_update() {
  if(server.arg("update") == "ok")
  {
    ...
    ////if(sensorUl==9)getNarodmon();
      if(printCom) { Serial.println(" обновление погоды наверноезвук страницы");}
    server.send(200, "text/plain", "OK");
  }
}
//======================================================================================================
